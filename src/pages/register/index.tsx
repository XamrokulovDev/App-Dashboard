    ...
    <div className="max-w-xl mx-auto bg-white p-6 rounded-md shadow-md my-20 max-md:my-10 border border-gray-300">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        {[
          ...
          <div className="mb-4" key={name}>
            ...
            {type === "select" ? (
              ...
              >
                {name === "placeOfBirth" && countries.map((country) => (
            ...
            {errors[name as keyof RegisterFormData] && <p className="text-red-500 text-xs">{errors[name as keyof RegisterFormData]?.message}</p>}
          </div>
        ))}

        <div className="mb-4">
          <label className="block text-lg font-medium text-gray-700">Gender</label>
          <select {...register("gender")} className="mt-1 p-2 w-full border border-gray-300 rounded outline-none py-2">
        ...
        <div className="mb-4">
          ...
          <select {...register("nationality")} className="mt-1 p-2 w-full border border-gray-300 rounded outline-none py-2">
        ...
        <div className="mb-4">
          ...
          <select {...register("maritalStatus")} className="mt-1 p-2 w-full border border-gray-300 rounded outline-none py-2">
